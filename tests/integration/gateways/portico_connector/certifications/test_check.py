...
class IntegrationGatewaysPorticoConnectorCertificationACHTests(unittest.TestCase):
    """
    ...
    def test_001_consumer_personal_checking(self):
        check = self.check(SecCode.PPD, CheckType.Personal, AccountType.Checking)
    ...
    def test_002_consumer_business_checking(self):
        check = self.check(SecCode.PPD, CheckType.Business, AccountType.Checking)
    ...
    def test_003_consumer_personal_savings(self):
        check = self.check(SecCode.PPD, CheckType.Personal, AccountType.Savings)
    ...
    def test_004_consumer_business_savings(self):
        check = self.check(SecCode.PPD, CheckType.Business, AccountType.Savings)
    ...
    def test_005_corporate_personal_checking(self):
        check = self.check(
            SecCode.CCD, CheckType.Personal, AccountType.Checking, "Heartland Pays"
        )
    ...
    def test_006_corporate_business_checking(self):
        check = self.check(
            SecCode.CCD, CheckType.Business, AccountType.Checking, "Heartland Pays"
        )
    ...
    def test_007_corporate_personal_savings(self):
        check = self.check(
            SecCode.CCD, CheckType.Personal, AccountType.Savings, "Heartland Pays"
        )
    ...
    def test_008_corporate_business_savings(self):
        check = self.check(
            SecCode.CCD, CheckType.Business, AccountType.Savings, "Heartland Pays"
        )
    ...
    def test_009_egold_personal_checking(self):
        check = self.check(SecCode.POP, CheckType.Personal, AccountType.Checking)
    ...
    def test_010_egold_business_checking(self):
        check = self.check(SecCode.POP, CheckType.Business, AccountType.Checking)
    ...
    def test_011_egold_personal_savings(self):
        check = self.check(SecCode.POP, CheckType.Personal, AccountType.Savings)
    ...
    def test_012_egold_business_savings(self):
        check = self.check(SecCode.POP, CheckType.Business, AccountType.Savings)
    ...
    def test_017_ebronze_personal_checking(self):
        check = self.check(SecCode.EBronze, CheckType.Personal, AccountType.Checking)
    ...
    def test_018_ebronze_business_checking(self):
        check = self.check(SecCode.EBronze, CheckType.Business, AccountType.Checking)
    ...
    def test_019_ebronze_personal_savings(self):
        check = self.check(SecCode.EBronze, CheckType.Personal, AccountType.Savings)
    ...
    def test_020_ebronze_business_savings(self):
        check = self.check(SecCode.EBronze, CheckType.Business, AccountType.Savings)
